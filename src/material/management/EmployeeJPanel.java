...
public class EmployeeJPanel extends javax.swing.JPanel {
    ...
    public EmployeeJPanel() {
        try {
            ...
            txtIDEmp.setText(dbi.getIDEmp());
            list = dbi.selectAllEmp();
//            for (Employee i : list){
...
//            }
    ...
    private void butInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butInsertActionPerformed
        ...
        try {
            ...
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.insertEmp(p.getIDEmp(), p.getNameEmp(), p.getPhone(), p.getEmail());
    ...
    private void butUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butUpdateActionPerformed
        ...
        try {
            ...
            p.setEmail(txtEmail.getText());
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.updateEmp(p.getIDEmp(), p.getNameEmp(), p.getPhone(), p.getEmail());
    ...
    private void butDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butDeleteActionPerformed
        ...
        try {
            ...
            p.setEmail(txtEmail.getText());
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.deleteEmp(p.getIDEmp(), p.getNameEmp(), p.getPhone(), p.getEmail());
...
//                    try {
                    list = dbi.selectByConditionEmp("IDEmp like '%" + txtIDEmp.getText() + "%'");
                    showData();
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
                ...
                if (txtNameEmp.getText().equals("")) {
                    JOptionPane.showMessageDialog(this, "No information to search");
                } else {
//                    try {
                    list = dbi.selectByConditionEmp("NameEmp like '%" + txtNameEmp.getText() + "%'");
                    showData();
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
...
//                    try {
                    list = dbi.selectByConditionEmp("Phone like '%" + txtPhone.getText() + "%'");
                    showData();
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
...
//                    try {
                    list = dbi.selectByConditionEmp("Email like '%" + txtEmail.getText() + "%'");
                    showData();
//                    } catch (Exception e) {
//                        e.printStackTrace();
//                    }
