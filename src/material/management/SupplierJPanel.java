...
public class SupplierJPanel extends javax.swing.JPanel {
    ...
    public SupplierJPanel() {
        try {
            ...
            txtIDSup.setText(dbi.getIDSup());
            list = dbi.selectAllSup();
//            for (Employee i : list){
...
//            }
    ...
    private void butInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butInsertActionPerformed
        ...
        try {
            ...
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.insertSup(p.getIDSup(), p.getSupName(), p.getDateAdd(), p.getPhone(), p.getEmail());
    ...
    private void butUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butUpdateActionPerformed
        ...
        try {
            ...
            p.setEmail(txtEmail.getText());
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.updateSup(p.getIDSup(), p.getSupName(), p.getDateAdd(), p.getPhone(), p.getEmail());
    ...
    private void butDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butDeleteActionPerformed
        ...
        try {
            ...
            p.setEmail(txtEmail.getText());
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.deleteSup(p.getIDSup(), p.getSupName(), p.getDateAdd(), p.getPhone(), p.getEmail());
        ...
        try {
            ...
            if (selectedItem.equals("IDSup")) {
                if (txtIDSup.getText().equals("")) {
                    ...
                    list = dbi.selectByConditionSup("IDSup like '%" + txtIDSup.getText() + "%'");
                    showData();
                }
                ...
                if (txtSupName.getText().equals("")) {
                    ...
                    list = dbi.selectByConditionSup("SupName like '%" + txtSupName.getText() + "%'");
                    showData();
                }
                ...
                if (txtDateAdd.getText().equals("")) {
                    ...
                    list = dbi.selectByConditionSup("DateAdd like '%" + txtDateAdd.getText() + "%'");
                    showData();
                }
                ...
                if (txtPhone.getText().equals("")) {
                    ...
                    list = dbi.selectByConditionSup("Phone like '%" + txtPhone.getText() + "%'");
                    showData();
                }
                ...
                if (txtEmail.getText().equals("")) {
                    ...
                    list = dbi.selectByConditionSup("Email like '%" + txtEmail.getText() + "%'");
                    showData();
                }
            }
        } catch (Exception e) {
