...
//            ArrayList<Product> list = ProductDAO.filterProductByName(name, category);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            Product product = dbi.getProductBuyByName(productName);
    ...
    private void butGenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGenerateActionPerformed
        ...
        try {
            ...
            p.setIDSup(Integer.parseInt(dbi.getIDSup()));
            p.setSupName(supName);
            p.setDateAdd(todaydate);
            p.setPhone(supPhone);
            p.setEmail(supEmail);

            ArrayList<Supplier> list = dbi.selectByConditionSup("SupName = '" + supName + "'");
            if (list.isEmpty()) {
                dbi.insertSup(p.getIDSup(), p.getSupName(), p.getDateAdd(), p.getPhone(), p.getEmail());
            }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            billID = Integer.parseInt(dbi.getIDImport());
            jlbID.setText(dbi.getIDImport());
