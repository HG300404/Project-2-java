...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void butUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butUpdateActionPerformed
        ...
        try {
            ...
            list1 = dbi.selectByConditionUser("UserName='" + txtUserName.getText() + "' and IDUser='" + txtIDUser.getText() + "'");
            if (list1.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Wrong information");
            } else {
                list2 = dbi.selectByConditionEmp("IDEmp='" + txtIDUser.getText() + "' and Email='" + txtEmail.getText() + "'");
                if (list2.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Wrong information");
                } else {
                    String enrText = null;
                    enrText = dbi.encrypt(NewPassword);
                    int result = dbi.updateUser(UserName, enrText, "employee", Integer.parseInt(IDUser));
