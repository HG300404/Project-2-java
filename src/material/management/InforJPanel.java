...
//            }
    ...
    private void butUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butUpdateActionPerformed
        ...
        try {
            ...
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result1 = dbi.updateInfor(p.getIDEmp(), p.getNameEmp(), p.getPhone(), p.getEmail());
            int result2 = dbi.updateEmp(p.getIDEmp(), p.getNameEmp(), p.getPhone(), p.getEmail());
