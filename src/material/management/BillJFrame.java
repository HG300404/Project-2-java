...
public class BillJFrame extends javax.swing.JFrame {
    ...
    public BillJFrame() {
        try {
            ...
            tf.setEnabled(true);
            ArrayList<Infor> listInfor = dbi.selectAllInfor();
...
//        ArrayList<Product> list = ProductDAO.getAllRecordsByCategory(category);
            ArrayList<Product> list = dbi.selectByConditionPro("TypeName='" + category + "'");
...
//            ArrayList<Product> list = ProductDAO.filterProductByName(name, category);
            ArrayList<Product> list = dbi.selectByConditionPro("ProductName like '%" + name + "%' and TypeName ='" + category + "'");
            Iterator<Product> itr = list.iterator();
            while (itr.hasNext()) {
                Product productObj = itr.next();
                dtm.addRow(new Object[]{productObj.getProductName()});
    ...
    private void initComponents() {
        ...
        butPay.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        butPay.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pay.png"))); // NOI18N
        butPay.setText("Pay");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(butPay, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(532, 532, 532)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            Product product = dbi.getProductSellByName(productName);
    ...
    private void butAddtoCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butAddtoCartActionPerformed
        ...
        try {
            ...
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            ArrayList<Product> list = dbi.selectByConditionPro("ProductName = '" + name + "'");
            for (Product p : list) {
                int kq = dbi.updateByProductName(name, p.getAmount() - Integer.parseInt(quantity));
            }
    ...
    private void butGenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butGenerateActionPerformed
        ...
        try {
            ...
            p.setIDCus(Integer.parseInt(dbi.getIDCus()));
            ...
            ArrayList<Customer> list = dbi.selectByConditionCus("CusName = '" + customerName + "'");
            if (list.isEmpty()) {
                dbi.insertCus(p.getIDCus(), p.getCusName(), p.getDateAdd(), p.getPhone(), p.getEmail(), p.getUnpaid());
            } else {
                for (Customer c : list) {
                    ...
                    dbi.updateCus(c.getIDCus(), c.getCusName(), c.getDateAdd(), c.getPhone(), c.getEmail(), c.getUnpaid());
                }
            }
//         String total = String.valueOf(grandTotal);
            ...
            for (int i = 0; i < jTable2.getRowCount(); i++) {
                ...
                ArrayList<Revenue> listRevenue = dbi.selectByConditionRev("Date='" + todaydate + "'and ProductName='" + productname + "'");
                if (listRevenue.isEmpty()) {
                    Revenue r = new Revenue(todaydate, productname, price, quantityproduct, totalproduct);
                    dbi.insertRev(r.getDate(), r.getProductName(), r.getPrice(), r.getQuantity(), r.getTotal());
                } else {
...
//                    r.setQuantity(total);
                        r.setTotal(String.valueOf(total));
                    }
                }
            }
...
//        bill.setTotal(total);
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            billID = Integer.parseInt(dbi.getIDBill());
            jlbBillID.setText(dbi.getIDBill());
            ArrayList<Category> list = dbi.selectAllCat();
...
//        DefaultTableModel dtm = (DefaultTableModel) jTable2.getModel();
    ...
    private void butPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butPayActionPerformed
        // TODO add your handling code here:
        int pay = Integer.parseInt(txtUnpaid.getText());
        pay = pay + grandTotal;
        txtUnpaid.setText("0");
        jlbGrandTotal.setText(String.valueOf(pay));
        grandTotal = pay;
