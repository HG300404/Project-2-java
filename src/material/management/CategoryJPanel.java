...
public class CategoryJPanel extends javax.swing.JPanel {
    ...
    public CategoryJPanel() {
        try {
            ...
            txtIDCategory.setText(dbi.getIDCat());
            list = dbi.selectAllCat();
//            for (Employee i : list){
...
//            }
    ...
    public void validateField() {
        ...
        if (!category.equals("")) {
            butInsert.setEnabled(true);
        } else {
            butInsert.setEnabled(false);
        }
    }
    ...
    private void butInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butInsertActionPerformed
        ...
        try {
            ...
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.insertCat(p.getIDCategory(), p.getCategory());
    ...
    private void butDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butDeleteActionPerformed
        ...
        p.setCategory(txtCategory.getText());
            DAOInterface dbi = (DAOInterface) Naming.lookup("rmi://localhost:9999/db");
            int result = dbi.deleteCat(p.getIDCategory(), p.getCategory());
